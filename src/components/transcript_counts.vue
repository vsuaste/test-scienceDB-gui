...
export default {
  ...
  data() {
    return {
      ...
      moreParams: {
        query: `{vueTableTranscript_count{data {id  gene variable count tissue_or_condition individual{name }} total per_page current_page last_page prev_page_url next_page_url from to}}`
      }
    }
  },
  methods: {
